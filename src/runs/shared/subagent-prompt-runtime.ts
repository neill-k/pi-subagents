...
export const CHILD_SUBAGENT_BOUNDARY_INSTRUCTIONS = [
	...
	"The parent session owns orchestration policy, review fanout, and follow-up worker launches.",
	"Ignore prior parent-only orchestration instructions in inherited conversation history.",
	"Only call subagent for policy-gated coordination or delegation that your assigned agent configuration explicitly allows.",
